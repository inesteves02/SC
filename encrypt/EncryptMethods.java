...
public class EncryptMethods {
    ...
    public static void encrypt(SecretKey key, Cipher c, String fileName, List<String> data) {
        stringArrayToFile(data, fileName);
        encryptFile(key, c, fileName);
    }
    ...
    public static void encryptFile(SecretKey key, Cipher c, String fileName) {
        FileInputStream fis;
    ...
    public static List<String> decrypt(SecretKey key, Cipher c, String fileName) {
        FileInputStream fis;
        FileOutputStream fos;
        CipherOutputStream cos;
        try {
            String[] aux = fileName.split("\\.");
            byte[] params = readParams(aux[0] + "Params.enc");
            ...
            List<String> res = fileToStringArray();
            if (!res.isEmpty()) {
